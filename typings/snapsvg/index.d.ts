...
declare function Snap(): Snap.Paper;
...
declare namespace Snap {
  ...
  export interface Element {
    ...
    attr(param: string, value: string | number | boolean | BBox | any): Snap.Element;
  ...
  interface Paper extends Snap.Element {
    ...
    circle(x: Size, y: Size, r: number): Snap.Element;
    circle(x: string, y: string, r: number): Snap.Element;
    ellipse(x: Size, y: Size, rx: Size, ry: Size): Snap.Element;
    image(src: string): Snap.Element;
    image(src: string, x: Size, y: Size, width: number, height: number): Snap.Element;
    line(x1: Size, y1: Size, x2: Size, y2: Size): Snap.Element;
    path(pathSpec: string | (string | number)[][]): Snap.Element;
    polygon(varargs: any[]): Snap.Element;
    polyline(varargs: any[]): Snap.Element;
    rect(): Snap.Element;
    rect(x: Size, y: Size, width: Size, height: Size, rx?: Size, ry?: Size): Snap.Element;
    text(x: Size, y: Size, text: string | number): Snap.Element;
    text(x: Size, y: Size, text: Array<string | number>): Snap.Element;
